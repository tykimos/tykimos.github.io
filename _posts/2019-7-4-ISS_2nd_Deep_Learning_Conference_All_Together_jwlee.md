---
layout: post
title:  "[2nd DLCAT] Efficient CNN 톺아보기 - 이진원"
author: 김태영
date:   2019-07-04 15:00:00
categories: seminar
comments: true
image: http://tykimos.github.io/warehouse/2019-7-4-ISS_2nd_Deep_Learning_Conference_All_Together_jwlee_title.png
---
ImageNet에서 ResNet이 human performance를 뛰어넘은 이후 efficiency를 중요시하는 CNN들이 계속 연구되어 왔는데 최근까지의 흐름을 쭉 정리해보고자 합니다.

![img](http://tykimos.github.io/warehouse/2019-7-4-ISS_2nd_Deep_Learning_Conference_All_Together_jwlee_title.png)
...
#### 발표자료
* [다운로드](http://tykimos.github.io/warehouse/2019-7-4-ISS_2nd_Deep_Learning_Conference_All_Together_jwlee_file.pdf)
