...
|![img](http://tykimos.github.io/warehouse/2018-3-19-ISS_Python_Deep_Learning_Keras_with_Blocks_yoyogo96.jpg)|유용균, 한국원자력연구원 (라이트닝 톡)<br><br>[딥러닝을 이용한 최적설계 및 시물레이션 소개]<br><br>딥러닝 기술은 영상인식, 자율주행 등의 흔히 알려진 분야 뿐만 아니라 유체해석 등 전산 해석와 최적설계을 분야에도 적용되고 있습니다. 이에 관련된 연구 사례와 진행 중인 연구내용에 대해서 소개 드리겠습니다.|
...
* 분야별 라이트닝 톡 (15:00~15:30)
    * [딥러닝을 이용한 최적설계 및 시물레이션 소개] 유용균님, 한국원자력연구원
