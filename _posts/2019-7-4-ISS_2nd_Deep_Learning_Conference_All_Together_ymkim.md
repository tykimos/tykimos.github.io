---
layout: post
title:  "[2nd DLCAT] 딥러닝 모델 엑기스 추출(Knowlege Distillation) - 김유민"
author: 김태영
date:   2019-07-04 13:00:00
categories: seminar
comments: true
image: http://tykimos.github.io/warehouse/2019-7-4-ISS_2nd_Deep_Learning_Conference_All_Together_ymkim_title.png
---
여러 딥러닝 모델 압축 방법들 중 Knowledge Distillation분야의 연구 흐름을 관련 논문 리뷰를 통해 소개해드리려고 합니다.

![img](http://tykimos.github.io/warehouse/2019-7-4-ISS_2nd_Deep_Learning_Conference_All_Together_ymkim_title.png)
...
#### 발표자료
* [다운로드](http://tykimos.github.io/warehouse/2019-7-4-ISS_2nd_Deep_Learning_Conference_All_Together_ymkim_file.pdf)
