...
|주제|내용|
|-|-|
|케라스(80분)|딥러닝 개념과 케라스 코드를 살펴보고, 간단한 MLP, CNN, GAN를 시연해봅니다. 그리고 케라스 커뮤니티를 통해서 함께 즐기는 법에 대해서 알아봅니다.|
|캐글(80분)|데이터 분석 방법, 캐글 사용법, 여러가지 팁에 대해서 알아봅니다. 그리고 캐글 커뮤니티를 통해서 함께 즐기고 대회에 참여하는 방법에 대해서 알아봅니다.|
|강화학습(80분)|강화학습 개념과 간단한 코드를 살펴봅니다. 그리고 강화학습 코리아에서 이뤄지고 있는 프로젝트에 대해서 알아보고 함께 즐기는 법에 대해서 알아봅니다.|
...
|![img](http://tykimos.github.io/warehouse/images/gcs.jpg)|강천성, 캐글 코리아 운영자, 충남대 컴퓨터공학<br><br>소개|
|![img](http://tykimos.github.io/warehouse/images/lhh.jpg)|이현호, (주)인스페이스 인공지능연구실<br><br>소개|
|![img](http://tykimos.github.io/warehouse/images/yjw.jpg)|유지원, 강화학습 운영자<br><br>소개 추가|
...
|지역|날짜|시간|장소|
|-|-|-|-|
|(신청중)부산|4/11(목)|오후 6시 ~ 10시|부산창조경제혁신센터(해운대, 100명)|
|(신청중)광주|4/17(수)|오후 6시 ~ 10시|광주과학기술원(오룡동, 100명)|

* 부산창조경제혁신센터 상세 주소 : 부산시 해운대구 센텀중앙로 78 센텀그린타워 3층 
* 광주과학기술원 상세 주소 : 광주광역시 북구 첨단과기로 123(오룡동)
...
* 서울 구글코리아, 2/14(목) [마감]
* 대전테크노파크, 2/20(수) [마감]
* 부산창조경제혁신센터, 4/11(목), 18시-22시 [신청하기](https://goo.gl/forms/94Fla2TG2qO3Ctm33)
* 광주과학기술원, 4/17(수), 18시-22시 [신청하기](https://goo.gl/forms/94Fla2TG2qO3Ctm33)
