...
categories: seminar
comments: true
image: http://tykimos.github.io/warehouse/2019-7-4-ISS_2nd_Deep_Learning_Conference_All_Together_title6.png
---
...
![img](http://tykimos.github.io/warehouse/2019-7-4-ISS_2nd_Deep_Learning_Conference_All_Together_title6.png)
...
* 후원: 
   ...
   * ETRI 융합기술연구생산센터
   * 대전정보문화산업진흥원
   * (주)유클리드소프트 - 유클리드소프트는 정부부처 및 공공기관 서비스 개발을 통해 축적한 솔루션 기반 탄탄한 기술력에 빅데이터 분석, AI기반 CCTV 행동 패턴 분석, CNN, RNN 등 최신 기술을  접목하여, 고객의 핵심 가치에 더 나은 플러스 가치를 제공하기위해 오래전부터 노력해왔고, 현재 노력하고 있고, 앞으로도 노력하려는 회사입니다.
