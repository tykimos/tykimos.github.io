...
|13시|<b>남기현</b><br>(이론)딥러닝으로 오디오 만나보기|(이름:주제)|<b>홍원의</b><br>(실습)한페이지 논문잡기:찾고+읽고+쓰고+정리하기|(이름:주제)|<b>신경인</b><br>(실습)파이토치로 갈아타기 1|(이름:주제)|
...
|15시|<b>민규식</b><br>멀티에이전트 강화학습|<b>김태진</b><br>구글 코랩 TPU 알아보기|<b>김보섭</b><br>(실습)영화평점 데이터로 자연어처리 논문구현 입문 with PyTorch, TF 2.0 1|<b>이진원</b><br>Efficient CNN 톺아보기|<b>김경환,박진우</b><br>(실습)Rainbow로 달착륙부터 Atari까지 1|(이름:주제)|
